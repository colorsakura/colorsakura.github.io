...
// 配置信息
const config = {
  username: 'colorsakura', // GitHub repository 所有者，可以是个人或者组织。对应Gitalk配置中的owner
  repo: "colorsakura.github.io", // 储存评论issue的github仓库名，仅需要仓库名字即可。对应 Gitalk配置中的repo
  token: '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', // 前面申请的 personal access token
  sitemap: path.join(__dirname, './docs/sitemap.xml'), // 自己站点的 sitemap 文件地址
